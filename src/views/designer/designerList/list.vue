    ...
    <el-dialog center :title="dialogType=='add'? '新增设计师': dialogType=='edit'? '编辑设计师': '设计师详情'" :visible.sync="dialogFormVisible" width="40%">
      <el-form ref="form" :model="form" :rules="rules" label-width="120px" label-position="left" size="small">
        <el-form-item label="所属团队" prop="team">
          <el-select v-model="form.team" placeholder="请选择" style="width: 100%">
            <el-option
        ...
        <el-form-item label="设计师姓名" prop="name">
          <el-input v-model="form.name " :disabled="dialogType=='detail'" style="width: 100%" />
        </el-form-item>
        <el-form-item label="设计师账号" prop="phone">
          <el-input v-model="form.phone " :disabled="dialogType=='detail'" style="width: 100%" />
        </el-form-item>
        ...
        <el-form-item>
          ...
          <el-button v-if="dialogType!=='detail'" type="primary" @click="()=>alert('接口未完成')">保存</el-button>
          <el-button v-else type="primary" @click="()=>alert('接口未完成')">编辑</el-button>
          <el-button @click="dialogFormVisible = false">取消</el-button>
        </el-form-item>
      </el-form>
    </el-dialog>
...
export default {
  ...
  data() {
    ...
    return {
      ...
      rules: {
        team: [
          { required: true, message: '请选择设计师团队', trigger: 'change' }
        ],
        name: [
        ...
        system_end_time: [
          { required: true, message: '请输入选择设计师到期时间', trigger: 'blur' }
        ]
      },
      dialogType: 'add'
    }
  ...
  methods: {
    ...
    showDialog(type, form) {
      ...
      if (form && form.shop_id) {
        ...
        this.form.name = form.admin.name
        this.form.phone = form.admin.phone
        this.form.system_end_time = form.system_end_time
